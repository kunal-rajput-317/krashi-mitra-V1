...
_TITLE = "Sponsor KrashiMitra — reach Indian farmers"
_DESC = ("Advertise to Hindi-speaking farmers at the moment they check today's "
         "mandi price. Real Search Console numbers, plain rates, nothing you "
         "cannot verify.")
...
def _numbers_block() -> str:
    ...
    return (
        ...
        'spends.</p>'
        '<p><b>Which surfaces carry it.</b> Daily mandi prices across every '
        'state and district; village and district maps; Hindi guides on dosage, '
        'disease and season; livestock and the daily egg rate; government '
...
not an ad auction and not a CPM. We publish verified organic traffic above
and fixed pricing below so your media planners have total certainty — a flattering
rate calculated on our side is the first thing a media buyer checks and the fastest
way for us to lose one.</p>
{_tiers_block()}
