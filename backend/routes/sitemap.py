...
# /pashupalan/anda-rate is "daily" and that is the honest cadence, not an
# optimistic one: NECC publishes a new egg rate every morning and the fetch
# stores it, so the page genuinely changes daily. Its ~34 zone URLs are NOT
